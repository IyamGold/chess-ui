...
awesome now lets uninstall mcp-http from claude and reinstall so we can test the flow

### Prompt 12

give me the command for installing this mcp for claude code, chatGPT, open claw, claude desktop, etc

### Prompt 13

i mean this openclaw https://openclaw.ai/
