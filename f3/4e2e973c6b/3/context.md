...
yo we have a problem. our blockchain integration that lets us put game history/details as xml files on fluent testnet seems to be missing.

i remember we made a .md file where we documented the game architecture which included the onchain integration. can you find that for me?

### Prompt 21

which line is the onchain publishing on?
